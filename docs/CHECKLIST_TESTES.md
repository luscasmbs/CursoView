...
- [ ] **Item 1.5 — Arquitetura de Inicialização Limpa**
...
- [ ] **Item 2.5 — Container de Visualização**
...
- [ ] **Item 2.6 — Atributo de Identidade Visual**
...
- [ ] **Item 3.2 — Estado Inicial: Nome Completo**
...
- [ ] **Item 3.3 — Estado Inicial: Categoria**
...
- [ ] **Item 3.4 — Estado Inicial: Carga Horária**
...
- [ ] **Item 3.5 — Estado Inicial: Descrição Curta**
...
- [ ] **Item 5.2 — Restrição de Limite Mínimo: Nome Completo**
...
- [ ] **Item 5.3 — Restrição de Limite Máximo: Nome Breve**
...
- [ ] **Item 5.4 — Obrigatoriedade de Campo: Categoria**
...
- [ ] **Item 5.5 — Obrigatoriedade de Campo: Carga Horária**
...
- [ ] **Item 5.6 — Proteção Contra Tipagem Alfanumérica (Crash-Test)**
...
- [ ] **Item 5.7 — Validação Numérica de Sinal (Inteiro Positivo)**
...
- [ ] **Item 5.8 — Restrição de Limite Máximo: Descrição**
...
- [ ] **Item 5.9 — Acúmulo de Pendências Simultâneas**
...
- [ ] **Item 5.10 — Cenário de Sucesso Absoluto**
...
- [ ] **Item 6.2 — Botão "Carregar exemplo"**
...
- [ ] **Item 7.2 — Rolagem Vertical e Teclado**
...
- [ ] **Item 7.3 — Ciclo de Layout via Scaffold**
...
- [ ] **Item 7.4 — Alinhamento e Sobreposição Gráfica**
...
- [ ] **Item 7.5 — Área de Clique Mínima (Acessibilidade)**
...
- [ ] **Item 7.6 — Descrição de Mídia Semântica**
...
- [ ] **Item 7.7 — Implementação de Ferramental de Preview**
